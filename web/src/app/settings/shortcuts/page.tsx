...
import { ShortcutsPanel, SettingsSectionTitle } from '@/components/settings';
  ...
  return (
    <div className="min-h-dvh animate-app-fade-in p-4 text-foreground md:min-h-0 md:p-0">
      <div className="mb-6 flex items-center gap-4 md:hidden">
        ...
        <h1 className="font-display text-xl font-semibold tracking-tight">{t('settings.shortcutsPageTitle')}</h1>
      </div>
      <div className="space-y-3">
        <div className="hidden md:block">
          <SettingsSectionTitle title={t('settings.shortcutsPageTitle')} />
        </div>
        <ShortcutsPanel />
      </div>
    </div>
